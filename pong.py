...
def draw(canvas):
    ...
    pygame.draw.polygon(canvas, BLUE, [[paddle1_pos[0] - HALF_PAD_WIDTH, paddle1_pos[1] - HALF_PAD_HEIGHT],
    ...
    label1 = myfont1.render("Score " + str(l_score), 1, (255,140,0))
    canvas.blit(label1, (50, 20))

    myfont2 = pygame.font.SysFont("Arial", 20)
    label2 = myfont2.render("Score " + str(r_score), 1, (255,140,0))
